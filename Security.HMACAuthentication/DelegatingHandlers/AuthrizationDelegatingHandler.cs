...
namespace Security.HMACAuthentication.DelegatingHandlers
{
    public class AuthrizationDelegatingHandler : DelegatingHandler
    {
        private readonly IHashKeys _hashKeys;
        private readonly IAuthorisationHeaderSerializer _authHeaderSerializer;
        private readonly ISigner _signer;

        public AuthrizationDelegatingHandler(IHashKeys hashKeys)
        {
            _hashKeys = hashKeys;
            _signer = new Signer();
